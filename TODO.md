...
- allow custom map design
- allow changing certain parameters (max health, object damage, object bounciness)

- [ ] add all missing animals from moomoo
- sheep, goldfish, special sidney and other dev's bosses
...
- [ ] if consistently switching hats unusually, disconnect
